  ...
  return (
    <div class="md:col-span-2 bg-slate-800 rounded-xl p-4 border border-slate-200/10 relative overflow-hidden group">
      <div class="absolute top-0 right-0 p-4">
        <span class="font-headline text-6xl font-black text-sky-400/10 select-none">
      ...
      <div class="relative z-10">
        ...
        <h3 class="font-headline text-2xl font-bold mb-2">
          [{data.tag}] {data.name}
        </h3>
        <p class="text-sky-400 font-headline text-xl font-medium mb-6">
  ...
  return (
    <div class="bg-slate-800/50 p-6 md:p-4 rounded-xl border border-slate-500/30 transition-colors">
      <div class="flex justify-between items-start mb-4">
        <span class="font-headline text-sky-400 font-bold">
          #{rank.toString().padStart(2, "0")}
        </span>
      ...
      <div class="flex flex-row justify-between">
        <div class="flex flex-col">
          ...
          <p class="text-gray-400 font-headline text-sm">
            {formatPower(data.power)} Power
          </p>
        </div>
        {data.glory ? (
